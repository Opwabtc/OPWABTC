...
// App.tsx: EXATAMENTE como era antes — sem BrowserRouter, sem lazy
// Apenas adicionando a rota /dashboard
...
console.log('OK App.tsx — sem BrowserRouter');

// Navigation.tsx: desestrutura btcPrice/gasPrice direto do store (como original)
...
// Dashboard.tsx: usa store direto, sem BrowserRouter
