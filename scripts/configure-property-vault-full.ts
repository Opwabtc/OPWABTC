...
const PROPERTY_NFT_ADDR  = 'opt1sqr0n9qf4nv8y5huvpmpfwcfqg3dt5geqwutpe5y7'; // v4 (hrp=opt)
const OPWAY_YIELD_ADDR   = 'opt1sqryxvl6fypj72l77ncfave5cfpvxs5c2d596cdtv';  // OPWAYield v3
