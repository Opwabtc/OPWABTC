/**
 * PropertyVault deployment script — OPNet Testnet (Signet fork)
 * Usage: OPNET_MNEMONIC="..." npx tsx deploy-property-vault.ts
 */
...
const WASM_PATH   = './contracts/build/PropertyVault.wasm';
...
async function deploy(): Promise<void> {
    ...
    console.log('\n✓ PropertyVault deployed at:', deployment.contractAddress);
    console.log('\n═══════════════════════════════════════════════════════════════');
    console.log(' NEXT STEPS:');
    console.log(' 1. Wait ~1 block for deployment to confirm');
    console.log(' 2. Run set-vault-addresses.ts to configure all 3 contracts');
    console.log('    PROPERTY_VAULT_ADDR="' + deployment.contractAddress + '"');
    console.log('═══════════════════════════════════════════════════════════════');
}
