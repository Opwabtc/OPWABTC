...
export const CONTRACTS = {
  ...
  opwaCoin:    'opt1sqpk5vyt8huuf03rw0ux72xk0qraur00esssxjxyj' as string,
  propertyNft: 'opt1sqr7vwe0g0tx4n7qlyqtgyzxgtscswendyuda4sm7' as string,  // redeployed 2026-03-07
} as const;
